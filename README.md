...
- 目的
    ...
    - これまではせっかくリスナーからのメールを送っても、読まれる確率が低かったが、絶対にずんだもんがお便りに回答して、悩み相談に付き合ってくれることで、新たなUXの実現を！
      ...
      →→→メンタルヘルスの向上や、自分の書いたお便りを番組内で読み上げてもらえる嬉しさを味わう（実際の番組でもお便りを出してみようかなとユーザーに思わせるきっかけを作りたいのが我々の狙い）ことが期待できる。
...
- せっかくお便りを書いても読まれることがないのでがっかりしない
  （お便りを実際に番組で読まれる経験をしてもらうことで面白さを体験→→→→→実際の番組でもお便りを書いてみようかな、と思うきっかけを作ることができる）
